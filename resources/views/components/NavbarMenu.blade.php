...
<div class="dropdown dropdown-end">
    ...
    <ul class="dropdown-content z-[1] menu p-2 drop-shadow bg-green-700 rounded w-[300px]">
        <li><a href="https://pmb.stitastbr.ac.id/">Penerimaan Mahasiswa Baru</a></li>
        <li><a href="https://pmb.stitastbr.ac.id/#brosur">Brosur PMB</a></li>
    </ul>
</div>
<div class="dropdown dropdown-end">
    <div class="flex items-center gap-1" tabindex="0" role="button">
    ...
    <ul class="dropdown-content z-[1] menu p-2 drop-shadow bg-green-700 rounded w-[300px]">
        <li><a href="https://siamad.stitastbr.ac.id">SIAMAD</a></li>
    </ul>
</div>
<div class="dropdown dropdown-end">
    <div class="flex items-center gap-1" tabindex="0" role="button">
